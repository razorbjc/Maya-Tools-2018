# Maya Tools 2018
<b>INSTALLATION</b>
<br>These are a collection of Maya Modeling Tools I have written over the years. To use a script, just copy and paste all the text into Maya's script editor (Python Tab) and execute (highlight all and press 'Alt+Enter'). Or you could make shelf button (highlight all + middle mouse drag to shelf) Easy!
<br><br><br>
